KIDS Distribution saved on May 29, 2014@12:22:47
CAREWEB DISTRIBUTION (VISTA) 1.0
**KIDS**:CAREWEB DISTRIBUTION (VISTA) 1.0^CIA UTILITIES 1.2^CIA RPC BROKER 1.1^CAREWEB FRAMEWORK 1.0^CAREWEB NOTIFICATION 1.0^CAREWEB CONTEXT 1.0^CAREWEB CWADF 1.0^CAREWEB ALLERGY COVERSHEET 1.0^CAREWEB CONSULT COVERSHEET 1.0^
**KIDS**CAREWEB LAB COVERSHEET 1.0^

**INSTALL NAME**
CAREWEB DISTRIBUTION (VISTA) 1.0
"BLD",8492,0)
CAREWEB DISTRIBUTION (VISTA) 1.0^^1^3140529^n
"BLD",8492,6.3)
42
"BLD",8492,10,0)
^9.63^130^9
...
"RTN","RGCWFUTL",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 42
"RTN","RGCWFUTL",3,0)
...
CIA UTILITIES 1.2
"BLD",8482,0)
CIA UTILITIES 1.2^CIA UTILITIES^0^3140529^n
"BLD",8482,1,0)
^^3^3^3030224^^
"BLD",8482,1,1,0)
...
"RTN","CIAU",2,0)
 ;;1.2;CIA UTILITIES;**1**;Mar 20, 2007;Build 52
"RTN","CIAU",3,0)
...
"RTN","CIAU1",2,0)
 ;;1.2;CIA UTILITIES;;Mar 20, 2007;Build 52
"RTN","CIAU1",3,0)
 ;;Copyright 2000-2006, Medsphere Systems Corporation
"RTN","CIAU1",4,0)
 ;=================================================================
...
CIA RPC BROKER 1.1
"BLD",8484,0)
CIA RPC BROKER 1.1^CIA NETWORK COMPONENTS^0^3140529^n
"BLD",8484,1,0)
^9.61A^1^1^3101115^^^^
"BLD",8484,1,1,0)
...
"RTN","CIANBACT",2,0)
 ;;1.1;CIA NETWORK COMPONENTS;**001007**;Sep 18, 2007;Build 69
"RTN","CIANBACT",3,0)
...
"RTN","CIANBASY",2,0)
 ;;1.1;CIA NETWORK COMPONENTS;**001007,001009**;Sep 18, 2007;Build 69
"RTN","CIANBASY",3,0)
...
"RTN","CIANBLIS",2,0)
 ;;1.1;CIA NETWORK COMPONENTS;**001007,001008**;Sep 18, 2007;Build 69
"RTN","CIANBLIS",3,0)
...
"RTN","CIANBLOG",2,0)
 ;;1.1;CIA NETWORK COMPONENTS;**001007,001008**;Jan 3, 2008;Build 69
"RTN","CIANBLOG",3,0)
 ;;Copyright 2000-2008, Medsphere Systems Corporation
"RTN","CIANBLOG",4,0)
 ;=================================================================
...
"BLD",8485,0)
CAREWEB FRAMEWORK 1.0^CAREWEB FRAMEWORK^0^3140529^n
"BLD",8485,4,0)
^9.64PA^19941.21^2
"BLD",8485,4,999.1,0)
999.1
...
"RTN","RGCWFPAR",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 46
"RTN","RGCWFPAR",3,0)
...
0^3^B13217250
"RTN","RGCWFSER",1,0)
RGCWFSER ;RI/CBMI/DKM - JSON Serialization Support ;29-May-2014 12:08;PIW
"RTN","RGCWFSER",2,0)
 ;;1.0;RGCW;;14-March-2014;Build 46
"RTN","RGCWFSER",3,0)
 ;=================================================================
"RTN","RGCWFSER",4,0)
...
"BLD",8486,0)
CAREWEB NOTIFICATION 1.0^^0^3140529^n
"BLD",8486,4,0)
^9.64PA^19941.21^4
"BLD",8486,4,999.1,0)
999.1
...
0^1^B53872379
"RTN","RGCWXQ",1,0)
RGCWXQ ;RI/CBMI/DKM - Notification Support ;21-Mar-2014 12:08;PIW
"RTN","RGCWXQ",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 39
"RTN","RGCWXQ",3,0)
...
0^2^B1164816
"RTN","RGCWXQCV",1,0)
RGCWXQCV ;RI/CBMI/DKM - Cover Sheet: Alerts ;21-Mar-2014 12:08;PIW
"RTN","RGCWXQCV",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 39
"RTN","RGCWXQCV",3,0)
...
CAREWEB CONTEXT 1.0
"BLD",8487,0)
CAREWEB CONTEXT 1.0^^0^3140529^n
"BLD",8487,4,0)
^9.64PA^19941.21^4
"BLD",8487,4,999.1,0)
999.1
...
N X S X=$$GET1^DIQ(42,$$FIND1^DIC(42,,"X",VL("I")),44,"I") D:X GETBYIEN(.DATA,"Location",X,"location")
"DATA",999.1,7,0)
Provider^200
"DATA",999.1,7,10,0)
^999.11^3^3
...
"DATA",999.1,15,10,0)
^999.11^3^3
"DATA",999.1,15,10,1,0)
name^.01^F
"DATA",999.1,15,10,2,0)
abbreviation^1^F
"DATA",999.1,15,10,3,0)
institution^3^O
"DATA",999.1,15,10,3,10)
Institution
"DATA",999.2,1,0)
...
"RTN","RGCWENC1",2,0)
 ;;1.0;CAREWEB FRAMEWORK;**005004;20-Aug-2007 08:41;Build 44
"RTN","RGCWENC1",3,0)
 ; Visit creation API
"RTN","RGCWENC1",4,0)
GETVISIT(IN,OUT) ;
...
"RTN","RGCWENCX",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 44
"RTN","RGCWENCX",3,0)
...
0^9^B38991891
"RTN","RGCWPTCX",1,0)
RGCWPTCX ;RI/CBMI/DKM - Patient Context Object ;30-Apr-2014 14:18;PIW
"RTN","RGCWPTCX",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 44
"RTN","RGCWPTCX",3,0)
...
"RTN","RGCWARCV",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 35
"RTN","RGCWARCV",3,0)
...
"BLD",8489,0)
CAREWEB ALLERGY COVERSHEET 1.0^^0^3140529^n
"BLD",8489,4,0)
^9.64PA^19941.21^3
"BLD",8489,4,999.1,0)
999.1
...
RGCWARCV ;RI/CBMI/DKM - Cover Sheet: Adverse Reactions ;18-Mar-2014 18:10;DKM
"RTN","RGCWARCV",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 32
"RTN","RGCWARCV",3,0)
 ; Return adverse reaction info for a patient
"RTN","RGCWARCV",4,0)
LIST(DATA,DFN,UNRL,NOIN) ;
...
"BLD",8490,0)
CAREWEB CONSULT COVERSHEET 1.0^^0^3140529^n
"BLD",8490,4,0)
^9.64PA^19941.21^3
"BLD",8490,4,999.1,0)
999.1
...
"BLD",8491,0)
CAREWEB LAB COVERSHEET 1.0^^0^3140529^n
"BLD",8491,4,0)
^9.64PA^19941.21^3
"BLD",8491,4,999.1,0)
999.1
