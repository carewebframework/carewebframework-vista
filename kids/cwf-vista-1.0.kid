KIDS Distribution saved on Mar 21, 2014@13:24:40
...
CAREWEB DISTRIBUTION (VISTA) 1.0
"BLD",8492,0)
CAREWEB DISTRIBUTION (VISTA) 1.0^^1^3140321^n
"BLD",8492,6.3)
38
"BLD",8492,10,0)
^9.63^130^9
...
CIA UTILITIES 1.2
"BLD",8482,0)
CIA UTILITIES 1.2^CIA UTILITIES^0^3140321^n
"BLD",8482,1,0)
^^3^3^3030224^^
"BLD",8482,1,1,0)
...
"RTN","CIAU",2,0)
 ;;1.2;CIA UTILITIES;**1**;Mar 20, 2007;Build 48
"RTN","CIAU",3,0)
...
"RTN","CIAU1",2,0)
 ;;1.2;CIA UTILITIES;;Mar 20, 2007;Build 48
"RTN","CIAU1",3,0)
 ;;Copyright 2000-2006, Medsphere Systems Corporation
"RTN","CIAU1",4,0)
 ;=================================================================
...
"RTN","CIANBACT",2,0)
 ;;1.1;CIA NETWORK COMPONENTS;**001007**;Sep 18, 2007;Build 62
"RTN","CIANBACT",3,0)
...
"RTN","CIANBASY",2,0)
 ;;1.1;CIA NETWORK COMPONENTS;**001007,001009**;Sep 18, 2007;Build 62
"RTN","CIANBASY",3,0)
...
"RTN","CIANBLIS",2,0)
 ;;1.1;CIA NETWORK COMPONENTS;**001007,001008**;Sep 18, 2007;Build 62
"RTN","CIANBLIS",3,0)
...
"RTN","CIANBLOG",2,0)
 ;;1.1;CIA NETWORK COMPONENTS;**001007,001008**;Jan 3, 2008;Build 62
"RTN","CIANBLOG",3,0)
 ;;Copyright 2000-2008, Medsphere Systems Corporation
"RTN","CIANBLOG",4,0)
 ;=================================================================
...
"RTN","RGCWFSER",2,0)
 ;;1.0;RGCW;;14-March-2014;Build 39
"RTN","RGCWFSER",3,0)
 ;=================================================================
"RTN","RGCWFSER",4,0)
...
"BLD",8486,0)
CAREWEB NOTIFICATION 1.0^^0^3140321^n
"BLD",8486,4,0)
^9.64PA^19941.21^4
"BLD",8486,4,999.1,0)
999.1
...
"RTN","RGCWENC1",2,0)
 ;;1.0;CAREWEB FRAMEWORK;**005004;20-Aug-2007 08:41;Build 37
"RTN","RGCWENC1",3,0)
 ; Visit creation API
"RTN","RGCWENC1",4,0)
GETVISIT(IN,OUT) ;
...
"RTN","RGCWARCV",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 31
"RTN","RGCWARCV",3,0)
...
"BLD",8489,0)
CAREWEB ALLERGY COVERSHEET 1.0^^0^3140321^n
"BLD",8489,4,0)
^9.64PA^19941.21^3
"BLD",8489,4,999.1,0)
999.1
...
RGCWARCV ;RI/CBMI/DKM - Cover Sheet: Adverse Reactions ;18-Mar-2014 18:10;DKM
"RTN","RGCWARCV",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 28
"RTN","RGCWARCV",3,0)
 ; Return adverse reaction info for a patient
"RTN","RGCWARCV",4,0)
LIST(DATA,DFN,UNRL,NOIN) ;
...
"BLD",8490,0)
CAREWEB CONSULT COVERSHEET 1.0^^0^3140321^n
"BLD",8490,4,0)
^9.64PA^19941.21^3
"BLD",8490,4,999.1,0)
999.1
...
"BLD",8491,0)
CAREWEB LAB COVERSHEET 1.0^^0^3140321^n
"BLD",8491,4,0)
^9.64PA^19941.21^3
"BLD",8491,4,999.1,0)
999.1
