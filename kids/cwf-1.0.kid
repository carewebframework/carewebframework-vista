KIDS Distribution saved on Mar 20, 2014@15:49:42
CAREWEB DISTRIBUTION 1.0
**KIDS**:CAREWEB DISTRIBUTION 1.0^CIA UTILITIES 1.2^CIA RPC BROKER 1.1^CAREWEB FRAMEWORK 1.0^CAREWEB NOTIFICATION 1.0^CAREWEB CONTEXT 1.0^CAREWEB CWADF 1.0^CAREWEB ALLERGY COVERSHEET 1.0^CAREWEB CONSULT COVERSHEET 1.0^
**KIDS**CAREWEB LAB COVERSHEET 1.0^

**INSTALL NAME**
CAREWEB DISTRIBUTION 1.0
"BLD",8492,0)
CAREWEB DISTRIBUTION 1.0^^1^3140320^n
"BLD",8492,6.3)
37
"BLD",8492,10,0)
^9.63^130^9
...
"BLD",8492,10,"B","CIA RPC BROKER 1.1",30)
...
"RTN","RGCWFUTL",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 37
"RTN","RGCWFUTL",3,0)
...
CIA UTILITIES 1.2
"BLD",8482,0)
CIA UTILITIES 1.2^CIA UTILITIES^0^3140320^n
"BLD",8482,1,0)
^^3^3^3030224^^
"BLD",8482,1,1,0)
...
"RTN","CIAU",2,0)
 ;;1.2;CIA UTILITIES;**1**;Mar 20, 2007;Build 47
"RTN","CIAU",3,0)
...
"RTN","CIAU1",2,0)
 ;;1.2;CIA UTILITIES;;Mar 20, 2007;Build 47
"RTN","CIAU1",3,0)
 ;;Copyright 2000-2006, Medsphere Systems Corporation
"RTN","CIAU1",4,0)
 ;=================================================================
...
CIA RPC BROKER 1.1
"BLD",8484,0)
CIA RPC BROKER 1.1^CIA NETWORK COMPONENTS^0^3140320^n
"BLD",8484,1,0)
^9.61A^1^1^3101115^^^^
"BLD",8484,1,1,0)
...
"RTN","CIANBACT",2,0)
 ;;1.1;CIA NETWORK COMPONENTS;**001007**;Sep 18, 2007;Build 60
"RTN","CIANBACT",3,0)
...
"RTN","CIANBASY",2,0)
 ;;1.1;CIA NETWORK COMPONENTS;**001007,001009**;Sep 18, 2007;Build 60
"RTN","CIANBASY",3,0)
...
"RTN","CIANBLIS",2,0)
 ;;1.1;CIA NETWORK COMPONENTS;**001007,001008**;Sep 18, 2007;Build 60
"RTN","CIANBLIS",3,0)
...
"RTN","CIANBLOG",2,0)
 ;;1.1;CIA NETWORK COMPONENTS;**001007,001008**;Jan 3, 2008;Build 60
"RTN","CIANBLOG",3,0)
 ;;Copyright 2000-2008, Medsphere Systems Corporation
"RTN","CIANBLOG",4,0)
 ;=================================================================
...
"BLD",8485,0)
CAREWEB FRAMEWORK 1.0^CAREWEB FRAMEWORK^0^3140320^n
"BLD",8485,4,0)
^9.64PA^19941.21^2
"BLD",8485,4,999.1,0)
999.1
...
"RTN","RGCWFPAR",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 36
"RTN","RGCWFPAR",3,0)
...
"RTN","RGCWFSER",2,0)
 ;;1.0;RGCW;;14-March-2014;Build 36
"RTN","RGCWFSER",3,0)
 ;=================================================================
"RTN","RGCWFSER",4,0)
...
"BLD",8486,0)
CAREWEB NOTIFICATION 1.0^^0^3140320^n
"BLD",8486,4,0)
^9.64PA^19941.21^4
"BLD",8486,4,999.1,0)
999.1
...
"DATA",19941.21,10,0)
NOTIFICATION.SCHEDULE^^60^^^1
"DATA",19941.21,10,1)
D SCHCHECK^RGCWXQ
"DATA",19941.21,26,0)
NOTIFICATION.MONITOR^0^60^^^0
"DATA",19941.21,26,1)
D ALRCHECK^RGCWXQ
...
RGCKDIN ;RI/CBMI/DKM - CareWeb KIDS installation support ;18-Mar-2014 23:53;DKM
"RTN","RGCWKDIN",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 34
"RTN","RGCWKDIN",3,0)
 ; Environment check
"RTN","RGCWKDIN",4,0)
EC X $G(@XPDGREF@("EC"))
...
0^1^B54614401
"RTN","RGCWXQ",1,0)
RGCWXQ ;RI/CBMI/DKM - Notification Support ;18-Mar-2014 16:27;DKM
"RTN","RGCWXQ",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 34
"RTN","RGCWXQ",3,0)
 ;=================================================================
...
"RTN","RGCWXQ",12,0)
 S ALL='$L($G(DFN)),DFN=+$G(DFN),(ALX,TOT)=0,TMP=$$TMPGBL^CIAURPC,FN=999.201,NOW=$$NOW^XLFDT,ST=+$G(ST)
"RTN","RGCWXQ",13,0)
...
"RTN","RGCWXQ",62,0)
 S ST=$$GETVAR^CIANBUTL("START",0,"RGCWXQ"),TMP=$$TMPGBL^CIAURPC(1),X=""
"RTN","RGCWXQ",63,0)
...
"RTN","RGCWXQ",66,0)
 ..D QUEUE^CIANBEVT("NOTIFICATION.ADD",@TMP@(X,Y))
"RTN","RGCWXQ",67,0)
 K @TMP
"RTN","RGCWXQ",68,0)
...
"RTN","RGCWXQ",69,0)
 .Q:$D(^XTV(8992,"AXQA",X))
"RTN","RGCWXQ",70,0)
 .D QUEUE^CIANBEVT("NOTIFICATION.DELETE",X),SETVAR^CIANBUTL(X,,"RGCWXQ.AID")
"RTN","RGCWXQ",71,0)
 Q
"RTN","RGCWXQ",72,0)
...
"RTN","RGCWXQ",137,0)
 D:DATA BRDCAST^CIANBEVT("NOTIFICATION.SCHEDULE.ADD","",.SUB)
"RTN","RGCWXQ",138,0)
 Q
"RTN","RGCWXQ",139,0)
...
"RTN","RGCWXQ",168,0)
 D:DATA BRDCAST^CIANBEVT("NOTIFICATION.SCHEDULE.DELETE",IEN,.SUB)
"RTN","RGCWXQ",169,0)
 Q
"RTN","RGCWXQ",170,0)
...
0^2^B1164816
"RTN","RGCWXQCV",1,0)
RGCWXQCV ;RI/CBMI/DKM - Cover Sheet: Alerts ;18-Mar-2014 22:25;DKM
"RTN","RGCWXQCV",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 34
"RTN","RGCWXQCV",3,0)
...
"RTN","RGCWXQCV",8,0)
 N GBL,LP,CNT,X,Y
"RTN","RGCWXQCV",9,0)
 S DATA=$$TMPGBL^CIAURPC,GBL=$$TMPGBL^CIAURPC(1)
"RTN","RGCWXQCV",10,0)
...
"TEMP","PTRS",19941.212)
20^19941.21^19.1
"TEMP","PTRS",19941.212,"NOTIFICATION.MONITOR")

"TEMP","PTRS",19941.212,"NOTIFICATION.SCHEDULE")

"TEMP","PTRS",19941.2121)
21^19941.21^19.1
"TEMP","PTRS",19941.2121,"NOTIFICATION.MONITOR")

"TEMP","PTRS",19941.2121,"NOTIFICATION.SCHEDULE")
...
CAREWEB CONTEXT 1.0
"BLD",8487,0)
CAREWEB CONTEXT 1.0^^0^3140320^n
"BLD",8487,4,0)
^9.64PA^19941.21^4
"BLD",8487,4,999.1,0)
999.1
...
"RTN","RGCWENC1",2,0)
 ;;1.0;CAREWEB FRAMEWORK;**005004;20-Aug-2007 08:41;Build 34
"RTN","RGCWENC1",3,0)
 ; Visit creation API
"RTN","RGCWENC1",4,0)
GETVISIT(IN,OUT) ;
...
0^9^B39444818
"RTN","RGCWPTCX",1,0)
RGCWPTCX ;RI/CBMI/DKM - Patient Context Object ;17-Mar-2014 15:59;DKM
"RTN","RGCWPTCX",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 34
"RTN","RGCWPTCX",3,0)
 ;=================================================================
...
0^3^B27496836
"RTN","RGCWPTP1",1,0)
RGCWPTP1 ;RI/CBMI/DKM - Patient List Management ;17-Mar-2014 16:02;DKM
"RTN","RGCWPTP1",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 34
"RTN","RGCWPTP1",3,0)
...
0^4^B6193954
"RTN","RGCWPTP2",1,0)
RGCWPTP2 ;RI/CBMI/DKM - Patient List Management ;14-Mar-2014 18:10;DKM
"RTN","RGCWPTP2",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 34
"RTN","RGCWPTP2",3,0)
 ;=================================================================
...
0^5^B17490315
"RTN","RGCWPTP3",1,0)
RGCWPTP3 ;RI/CBMI/MGH - Patient List Management ;14-Mar-2014 18:10;DKM
"RTN","RGCWPTP3",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 34
"RTN","RGCWPTP3",3,0)
 ;=================================================================
...
0^6^B8413869
"RTN","RGCWPTPC",1,0)
RGCWPTPC ;RI/CBMI/DKM - RPC calls for provider information ;14-Mar-2014 18:10;DKM
"RTN","RGCWPTPC",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 34
"RTN","RGCWPTPC",3,0)
 ;=================================================================
...
0^7^B18902475
"RTN","RGCWPTPL",1,0)
RGCWPTPL ;RI/CBMI/DKM - Patient List Management ;17-Mar-2014 15:41;DKM
"RTN","RGCWPTPL",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 34
"RTN","RGCWPTPL",3,0)
 ;=================================================================
...
0^8^B4931019
"RTN","RGCWPTPS",1,0)
RGCWPTPS ;RGN/DKM - Patient search ;17-Mar-2014 15:41;DKM
"RTN","RGCWPTPS",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 34
"RTN","RGCWPTPS",3,0)
 ;=================================================================
...
RGCWCACV^^0^B10785487
"BLD",8488,"KRN",9.8,"NM",2,0)
RGCWARCV^^0^B34485048
...
"RTN","RGCWARCV",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 30
"RTN","RGCWARCV",3,0)
...
"RTN","RGCWARCV",7,0)
 S CNT=0
"RTN","RGCWARCV",8,0)
 S UNRL=$G(UNRL),IN=$G(IN),NOIN=$G(NOIN),(LP,CNT,ALCNT)=0,DATA=$$TMPGBL^CIAURPC
"RTN","RGCWARCV",9,0)
...
"RTN","RGCWCACV",12,0)
 S DATA=$$TMPGBL^CIAURPC,(CNT,LP)=0
"RTN","RGCWCACV",13,0)
...
"BLD",8489,0)
CAREWEB ALLERGY COVERSHEET 1.0^^0^3140320^n
"BLD",8489,4,0)
^9.64PA^19941.21^3
"BLD",8489,4,999.1,0)
999.1
...
RGCWARCV ;RI/CBMI/DKM - Cover Sheet: Adverse Reactions ;18-Mar-2014 18:10;DKM
"RTN","RGCWARCV",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 27
"RTN","RGCWARCV",3,0)
 ; Return adverse reaction info for a patient
"RTN","RGCWARCV",4,0)
LIST(DATA,DFN,UNRL,NOIN) ;
...
"BLD",8490,0)
CAREWEB CONSULT COVERSHEET 1.0^^0^3140320^n
"BLD",8490,4,0)
^9.64PA^19941.21^3
"BLD",8490,4,999.1,0)
999.1
...
"RTN","RGCWCNCV",8,0)
 S DATA=$$TMPGBL^CIAURPC,ADT=+$G(ADT)
"RTN","RGCWCNCV",9,0)
 K ^TMP("GMRCR",$J)
"RTN","RGCWCNCV",10,0)
...
"BLD",8491,0)
CAREWEB LAB COVERSHEET 1.0^^0^3140320^n
"BLD",8491,4,0)
^9.64PA^19941.21^3
"BLD",8491,4,999.1,0)
999.1
